...
versionSelect.on('change', function() {
    // Set the theme version to the selected value
    var selectedVersion = '3';
    body.attr('data-theme-version', selectedVersion);
    
    // Store the selected version in a cookie
    setCookie('themeVersion', selectedVersion);
    
    // Set the value of the dropdown to the selected version
